...
String s="select* from product p,order_item r,occupation o "+"where p.occu_no=o.occu_no and p.product_id=r.product_id group by p.product_id order by count(p.product_id) desc limit 5";
