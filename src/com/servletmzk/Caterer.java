...
/**
 * Servlet implementation class Caterer
 */
@WebServlet(asyncSupported = true, urlPatterns = { "/Caterer" })
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
    	 ArrayList<Catererstr> list=new ArrayList<Catererstr>();
 			...
 			try {
 				...
 				{
 					s="select* from product p,occupation o where o.occu_no=p.occu_no";
 				}
 				else
 				{
 					String cid = request.getParameter("id");
 					s="select* from product p,occupation o where o.occu_no=p.occu_no"+" and p.occu_no="+cid;
